...
class OrderFilter(FilterSet):
    ...
    skus_ordered = CharFilter(field_name='skus_ordered__inventory_item__name', lookup_expr='icontains', widget=TextInput(attrs={'placeholder': 'SKUs Ordered', 'class': 'form-control'}))
